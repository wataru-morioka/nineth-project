...
class Account(models.Model):
    uid = models.CharField(max_length=64, unique=True, null=False, default='')
    ...
    login_count = models.IntegerField(null=False, default=1)
    latest_login = models.DateTimeField(null=False)
    created_datetime = models.DateTimeField(null=False)
    modified_datetime = models.DateTimeField(null=False)
